 ...
 *
 * A public install can end up with `origin=git@github.com:cxhihilwb123-hash/jujing-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/cxhihilwb123-hash/jujing-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/cxhihilwb123-hash/jujing-agent'
