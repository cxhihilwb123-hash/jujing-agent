...
// plus JUJING_HOME/HERMES_HOME. We snapshot the values, not the live env, so the new
...
const PRESERVED_ENV_KEYS = ['JUJING_HOME', 'HERMES_HOME', 'ELECTRON_DISABLE_SANDBOX']
