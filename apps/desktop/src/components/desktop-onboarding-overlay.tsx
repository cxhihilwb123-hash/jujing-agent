...
export function Picker({ ctx }: { ctx: OnboardingContext }) {
  ...
  // Collapse the secondary providers behind a disclosure only when the managed
  // Jujing account provider is present to anchor the choice; otherwise show the full list.
