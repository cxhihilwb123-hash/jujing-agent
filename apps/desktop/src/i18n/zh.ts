...
export const zh: Translations = {
  ...
  notifications: {
    ...
    backendOutOfDateMessage: '你的 智能体后端早于当前桌面构建，可能无法正常工作。请更新以保持一致。',
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteTitle: '远程网关',
      remoteDesc:
        '将此桌面外壳连接到远程 智能体后端。托管网关使用 OAuth 或用户名密码；自托管网关也可能使用会话 token。',
      ...
      savedTitle: '网关设置已保存',
      restartingMessage: '巨鲸智能体将使用已保存设置重新连接。',
    ...
    toolsets: {
      ...
      ready: '就绪',
      nousIncluded: '包含在巨鲸网络订阅中；登录巨鲸账号即可激活。',
  ...
  sidebar: {
    ...
    projects: {
      ...
      createFailed: '无法创建项目',
      deleteConfirm: '这会从 巨鲸智能体中移除已保存的项目。文件、git 仓库和工作树保持不变。',
      startWork: '新建工作树',
  ...
  onboarding: {
    ...
    recommended: '推荐',
    connected: '已连接',
    featuredPitch: '巨鲸网络订阅，300+ 前沿模型 — 推荐的智能体运行方式',
    ...
    flowSubtitles: {
      ...
      device_code: '在浏览器中打开验证页面 — 巨鲸智能体会自动连接',
      loopback: '打开浏览器登录 — 巨鲸智能体会自动连接',
