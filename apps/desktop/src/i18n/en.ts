...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      restartingMessage: 'Jujing Agent will reconnect using the saved settings.',
    ...
    toolsets: {
      ...
      ready: 'Ready',
      nousIncluded: 'Included with a Jujing Network subscription — sign in to activate.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'This removes the saved project from Jujing Agent. Files, git repos, and worktrees stay untouched.',
  ...
  updates: {
    ...
    manualBody: 'You installed Jujing Agent from the command line, so updates run there too. Paste this into your terminal:',
  ...
  onboarding: {
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Jujing Agent at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      loopback: 'Opens your browser to sign in — Jujing Agent connects automatically',
  ...
  preview: {
    ...
    web: {
      ...
      finishedRestarting: message => `Jujing Agent finished restarting the preview server${message ? `: ${message}` : ''}`,
