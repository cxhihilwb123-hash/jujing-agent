...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHermesDesktop: 'Starting Jujing Agent…'
    },
    errors: {
    ...
    failure: {
      title: "Jujing Agent couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Jujing Agent backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Jujing Agent',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Jujing Agent.',
    ...
    native: {
      ...
      inputBody: 'Jujing Agent is waiting for your response.',
      turnDoneTitle: 'Jujing Agent finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Jujing Agent defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Jujing Agent writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Jujing Agent is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Jujing Agent asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Jujing Agent was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Jujing Agent follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Jujing Agent is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Jujing Agent, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Jujing Agent checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Jujing Agent configuration...',
    ...
    gateway: {
      ...
      intro:
        'Jujing Agent starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running agent backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      remoteDesc: 'Connect this desktop shell to a remote Jujing Agent backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Jujing Agent Cloud',
      cloudDesc: 'Sign in once to Jujing Agent Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Jujing Agent Cloud',
      cloudSignIn: 'Sign in to Jujing Agent Cloud',
      cloudSignedIn: 'Signed in to Jujing Agent Cloud',
      cloudNeedsSignIn: 'Sign in to Jujing Agent Cloud to discover the agents on your account.',
      ...
      cloudNoAgents: {
        ...
        linkText: 'Jujing Agent portal',
        after: ', then refresh.'
      },
      cloudRefresh: 'Refresh',
      cloudConnect: 'Connect',
      cloudConnecting: 'Connecting…',
      cloudDiscoverFailed: 'Could not load your Jujing Agent Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Jujing Agent Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Jujing Agent Cloud',
      cloudSignedOutMessage: 'Cleared the Jujing Agent Cloud session.',
      ...
      restartingMessage: 'Jujing Agent Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Jujing Agent ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Jujing Agent runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Jujing Agent at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      nousIncluded: 'Included with a Jujing Network subscription — sign in to Jujing Network account to activate.',
      nousAuthNeededTitle: 'Sign in to Jujing Network account',
      nousAuthNeededMessage: provider =>
        `${provider} is saved but won't activate until you sign in to Jujing Network account.`,
      nousAuthSignIn: 'Sign in',
      nousAuthDoneTitle: 'Jujing Network account connected',
      nousAuthDoneMessage: 'Your subscription backends are now active.',
      nousAuthFailed: 'Jujing Network account sign-in did not complete',
  ...
  starmap: {
    ...
    emptyDesc: 'As Jujing Agent builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Jujing Agent to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Jujing Agent to generate pets.',
      backgroundHint: 'You can close this — Jujing Agent will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Jujing Agent desktop' },
    ...
    hermesActiveSessions: (version, count) => `Jujing Agent ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Jujing Agent environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Jujing Agent will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Jujing Agent backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm:
        'This removes the saved project from Jujing Agent. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Jujing Agent...',
    placeholderReconnecting: 'Reconnecting to Jujing Agent…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Jujing Agent a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Jujing Agent will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Jujing Agent to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Jujing Agent…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Jujing Agent…',
    ...
    unsupportedMessage: 'This version of Jujing Agent can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Jujing Agent is ready to install.',
    ...
    manualBody:
      'You installed Jujing Agent from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Jujing Agent will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Jujing Agent desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Jujing Agent updater takes over in its own window and reopens Jujing Agent automatically when it’s done. Please don’t reopen Jujing Agent yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Jujing Agent reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Jujing Agent reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Jujing Agent needs a one-time install',
    ...
    settingUpTitle: 'Setting up Jujing Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Jujing Agent CLI or desktop instance is running. Stop any running Jujing Agent instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Jujing Agent installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Jujing Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Jujing Agent is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Jujing Agent…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Jujing Agent',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description:
          'Point Jujing Agent at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Jujing Agent connects automatically',
    ...
    authorizeThere: 'Authorize Jujing Agent there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Jujing Agent there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid Jujing Network subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Jujing Agent v${version}`,
      ...
      gatewayTitle: 'Jujing Agent inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Jujing Agent will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Jujing Agent is restarting...',
      askRestart: 'Ask Jujing Agent to restart the server',
      lookingRestart: taskId => `Jujing Agent is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Jujing Agent is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message =>
        `Jujing Agent finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Jujing Agent could not restart the server.',
      stillWorking:
        'Jujing Agent is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Jujing Agent is loading a response',
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Jujing Agent won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Jujing Agent needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Jujing Agent needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Jujing Agent to use Save Image.',
    restartToSaveImages: 'Restart Jujing Agent to save images',
