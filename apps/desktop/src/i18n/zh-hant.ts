...
export const zhHant = defineLocale({
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed: '桌面後端拒絕了該請求 (405 Method Not Allowed)。請嘗試重新啟動 巨鲸智能体。',
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverride: '環境變數覆寫',
      intro:
        '巨鲸智能体 預設會啟動自己的本機閘道。如果您希望此應用程式控制另一台機器或可信代理後面已執行的 智能体後端，請使用遠端閘道。在下方按設定檔指定各自的遠端主機。',
      appliesTo: '套用至',
      allProfiles: '全部設定檔',
      ...
      localTitle: '本機閘道',
      localDesc: '在 localhost 啟動私有 智能体後端。這是預設方式，可離線使用。',
      remoteTitle: '遠端閘道',
      remoteDesc:
        '將此桌面殼層連線至遠端 智能体後端。託管閘道使用 OAuth 或帳號密碼；自託管閘道也可使用工作階段 Token。',
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro 模型需要付費 巨鲸网络訂閱。',
    free: '免費',
    freeTier: '免費層',
  ...
  desktop: {
    ...
    restartToUseSaveImage: '重新啟動 巨鲸智能体 後可使用儲存圖片。',
    restartToSaveImages: '重新啟動 巨鲸智能体 以儲存圖片',
