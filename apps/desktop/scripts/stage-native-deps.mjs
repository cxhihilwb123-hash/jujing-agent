...
export function stageNodePty({
  platform = process.env.DESKTOP_TARGET_PLATFORM || process.env.npm_config_platform || process.platform,
  arch = process.env.DESKTOP_TARGET_ARCH || process.env.npm_config_arch || process.arch
} = {}) {
