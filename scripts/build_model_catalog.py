#!/usr/bin/env python3
"""Build the Jujing Model Catalog — a centralized JSON manifest of curated models.
...
Jujing runtime fetches at runtime. Publishing the catalog through the release
site lets maintainers update model lists without shipping a full desktop
release.
...
Live URL depends on the Jujing release site configuration.
"""
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "jujing-agent repo",
            "docs": "https://github.com/cxhihilwb123-hash/jujing-agent",
        },
        "providers": {
            "openrouter": {
                "metadata": {
